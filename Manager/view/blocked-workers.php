<?php
include '../controller/allBlockedWorker.php';
...
<section class="dashboard">
    <div class="container dashboard__container">
        <aside>
            ...
            li>
                ...
                <li>
                    <a href="blocked-workers.php" class="active><i class="fas fa-folder-plus"></i>
    ...
    while ($record = $result->fetch_assoc()) {
        ...
        // Profession
        echo "<td><h5>" . $record['profession'] . "</h5></td>";
        // Details Link
        echo "<td><a href='showWorker.php?username=" . $record['username'] . "' class='btn sm'>Details</a></td>";
 
        // Block Form
        echo "<td>";
        echo "<form method='POST' action='../controller/blockWorker.php'>";
        ...
        // Delete Form
        echo "<td>";
        echo "<form method='POST' action='../controller/deleteWorker.php'>";
        echo "<input type='hidden' name='username' value='" . $record['username'] . "'>";
